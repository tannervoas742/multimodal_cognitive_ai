...
deepspeed   llava/train/train_mem.py \
    ...
    --pretrain_mm_mlp_adapter $DATA_DIR/checkpoints/llava-mpt-${MODEL_VER}-pretrain_4k/mm_projector.bin \
    ...
    --bf16 True \
    --output_dir $DATA_DIR/checkpoints/llava-mpt-${MODEL_VER}-finetune_4k/ \
    --num_train_epochs 1 \
