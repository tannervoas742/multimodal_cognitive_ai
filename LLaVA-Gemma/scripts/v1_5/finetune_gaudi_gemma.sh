...
deepspeed   llava/train/train_mem.py \
    ...
    --pretrain_mm_mlp_adapter  $DATA_DIR/checkpoints/llava-gemma-${MODEL_VER}-pretrain/mm_projector.bin \
    ...
    --bf16 True \
    --output_dir $DATA_DIR/checkpoints/llava-gemma-${MODEL_VER}-finetune \
    --num_train_epochs 1 \
