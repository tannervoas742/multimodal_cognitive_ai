...
deepspeed   llava/train/train_mem.py \
    ...
    --pretrain_mm_mlp_adapter  /data0/visual-llama/checkpoints/llava-gemma-${MODEL_VER}-pretrain/checkpoint-20/mm_projector.bin \
    ...
    --bf16 True \
    --output_dir /data0/visual-llama/checkpoints/llava-gemma-${MODEL_VER}-finetune \
    --num_train_epochs 1 \
